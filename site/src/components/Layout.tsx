...
const X_URL = "https://x.com/fluel";
const TG_CHANNEL_URL = "https://t.me/fluel";
        ...
        <div class={s.footerInner}>
          ...
          <div class={s.footerTop}>
            ...
            <div class={s.footerCol}>
              ...
              <a href="https://github.com/maoandip/gas-station" target="_blank" rel="noopener" class={s.footerIconLink}>
